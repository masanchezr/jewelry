					...
					<tbody>
						<c:forEach items="${daily.sales}" var="sale">
							<tr>
								...
								<td><c:out value="${sale.total}" /><i class="fas fa-euro-sign"></i></td>
						...
						<c:forEach items="${daily.retiredpawns}" var="pawn">
							<tr>
								...
								<td><c:out value="${pawn.amount}" /><i class="fas fa-euro-sign"></i></td>
						...
						<c:forEach items="${daily.straps}" var="strap">
							<tr>
								...
								<td><c:out value="${strap.amount}" /><i class="fas fa-euro-sign"></i></td>
